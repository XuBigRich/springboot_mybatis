...
strFrame+='             Author=meizz align=center><input Author=meizz style="cursor:hand"  type=button class=button value="清空" onclick="parent.meizzClose()" ';
strFrame+='             onfocus="this.blur()" title="清空日期" style="font-size: 12px; height: 20px; cursor:hand">&nbsp;<input Author=meizz style="cursor:hand"  type=button class=button value="今天" onclick="parent.meizzToday()" ';
